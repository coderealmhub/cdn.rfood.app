    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
                ...
                o.infoMessage = 'O tamanho mínimo da senha é de ' + o.numCharacters + ' caracteres e deve conter pelo menos 1 letra minúscula, 1 maiúscula, 1 número e 1 caractere especial.';
				// Add Variables for the li elements
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>Nº de caracteres</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';
